...
routes['GET']['/display_success'] = 'Users#display_success'
routes['GET']['/add_a_trip'] = 'Users#add_a_trip'
routes['POST']['/add_process'] = 'Users#add_process'
routes['GET']['/logout'] = 'Users#logout'
routes['GET']['/join/<trip_id>'] = 'Users#join'
routes['GET']['/display_trip/<trip_id>'] = 'Users#display_trip'
"""
